...
| Create Supabase tables | Complete | Migration defines and live project verifies five V1 tables |
...
| Check Supabase access and project setup | Complete | MCP registered/authenticated, CLI linked, migration applied, live schema verified in `docs/SUPABASE_ACCESS_AND_PROJECT_SETUP_CHECK_2026-05-29.md` |

## External Limitation

The real Supabase project is linked and migrated. `EXPO_PUBLIC_SUPABASE_ANON_KEY` must remain outside source control and be set in the local/build environment before a signed-in app smoke test.
