...
export const BASE_COPY_KEYS = Object.freeze({
  ...
  SKILL_FOUNDING_PRO_BADGE: "base.skill.foundingProBadge",
  SKILL_CHALLENGE_START_CTA: "base.skillChallenge.startCta",
  SKILL_CHALLENGE_RETRY_CTA: "base.skillChallenge.retryCta",
  SKILL_CHALLENGE_SCORE_LABEL: "base.skillChallenge.scoreLabel",
  SKILL_CHALLENGE_PASSED_LABEL: "base.skillChallenge.passedLabel",
  SKILL_CHALLENGE_FAILED_LABEL: "base.skillChallenge.failedLabel",
  ...
  PRO_CONVERSION_HEARTS_TITLE: "base.proConversion.hearts.title",
  PRO_CONVERSION_HEARTS_BODY: "base.proConversion.hearts.body",
  PRO_CONVERSION_HEARTS_CTA: "base.proConversion.hearts.cta",
  PRO_CONVERSION_LOCKED_TITLE: "base.proConversion.locked.title",
  PRO_CONVERSION_LOCKED_BODY: "base.proConversion.locked.body",
  PRO_CONVERSION_LOCKED_CTA: "base.proConversion.locked.cta",
  PRO_CONVERSION_TIMER_STARTED_TITLE: "base.proConversion.timerStarted.title",
  PRO_CONVERSION_TIMER_STARTED_BODY: "base.proConversion.timerStarted.body",
  PRO_CONVERSION_TIMER_STARTED_CTA: "base.proConversion.timerStarted.cta",
  PRO_CONVERSION_FIRST_UPGRADE_TITLE: "base.proConversion.firstUpgrade.title",
  PRO_CONVERSION_FIRST_UPGRADE_BODY: "base.proConversion.firstUpgrade.body",
  PRO_CONVERSION_FIRST_UPGRADE_CTA: "base.proConversion.firstUpgrade.cta",
  PRO_CONVERSION_MAIN_TITLE: "base.proConversion.main.title",
  PRO_CONVERSION_MAIN_CTA: "base.proConversion.main.cta",
  PRO_CONVERSION_LAUNCH_BADGE: "base.proConversion.launchBadge",
  PRO_BENEFIT_BATTLES_TITLE: "base.proBenefit.battles.title",
  PRO_BENEFIT_BATTLES_BODY: "base.proBenefit.battles.body",
  PRO_BENEFIT_COINS_TITLE: "base.proBenefit.coins.title",
  PRO_BENEFIT_COINS_BODY: "base.proBenefit.coins.body",
  PRO_BENEFIT_TIMERS_TITLE: "base.proBenefit.timers.title",
  PRO_BENEFIT_TIMERS_BODY: "base.proBenefit.timers.body",
  PRO_BENEFIT_SKILLS_TITLE: "base.proBenefit.skills.title",
  PRO_BENEFIT_SKILLS_BODY: "base.proBenefit.skills.body",
  PRO_COMPARISON_QUICK_BATTLES: "base.proComparison.quickBattles",
  PRO_COMPARISON_COINS: "base.proComparison.coins",
  PRO_COMPARISON_TIMERS: "base.proComparison.timers",
  PRO_COMPARISON_SKILL_CHALLENGES: "base.proComparison.skillChallenges",
  PRO_COMPARISON_PAY_TO_WIN: "base.proComparison.payToWin",
  PRO_COMPARISON_FREE_QUICK_BATTLES: "base.proComparison.free.quickBattles",
  PRO_COMPARISON_FREE_COINS: "base.proComparison.free.coins",
  PRO_COMPARISON_FREE_TIMERS: "base.proComparison.free.timers",
  PRO_COMPARISON_FREE_SKILL_CHALLENGES: "base.proComparison.free.skillChallenges",
  PRO_COMPARISON_FREE_PAY_TO_WIN: "base.proComparison.free.payToWin",
  PRO_COMPARISON_PRO_QUICK_BATTLES: "base.proComparison.pro.quickBattles",
  PRO_COMPARISON_PRO_COINS: "base.proComparison.pro.coins",
...
const BASE_TRANSLATIONS = Object.freeze({
  [BASE_LANGUAGES.EN]: Object.freeze({
    ...
    [BASE_COPY_KEYS.SKILL_FOUNDING_PRO_BADGE]: "Founding Pro",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_START_CTA]: "Start Skill Challenge",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_RETRY_CTA]: "Retry Challenge",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_SCORE_LABEL]: "Score",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_PASSED_LABEL]: "Passed",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_FAILED_LABEL]: "Try Again",
    ...
    [BASE_COPY_KEYS.PRO_CONVERSION_HEARTS_TITLE]: "Launch Offer",
    [BASE_COPY_KEYS.PRO_CONVERSION_HEARTS_BODY]: "You used your free full-reward battles. Go Pro to continue playing without the 30-minute wait.",
    [BASE_COPY_KEYS.PRO_CONVERSION_HEARTS_CTA]: "Play Unlimited",
    [BASE_COPY_KEYS.PRO_CONVERSION_LOCKED_TITLE]: "Unlock Faster",
    [BASE_COPY_KEYS.PRO_CONVERSION_LOCKED_BODY]: "This building is locked. Upgrade faster and unlock your future kingdom with Sahib Pro.",
    [BASE_COPY_KEYS.PRO_CONVERSION_LOCKED_CTA]: "Unlock Faster",
    [BASE_COPY_KEYS.PRO_CONVERSION_TIMER_STARTED_TITLE]: "Future Timers",
    [BASE_COPY_KEYS.PRO_CONVERSION_TIMER_STARTED_BODY]: "Your upgrade has started. Sahib Pro reduces future build timers by 80%.",
    [BASE_COPY_KEYS.PRO_CONVERSION_TIMER_STARTED_CTA]: "Speed Up with Pro",
    [BASE_COPY_KEYS.PRO_CONVERSION_FIRST_UPGRADE_TITLE]: "Upgrade Faster",
    [BASE_COPY_KEYS.PRO_CONVERSION_FIRST_UPGRADE_BODY]: "Your kingdom is growing. Sahib Pro helps you keep upgrading faster.",
    [BASE_COPY_KEYS.PRO_CONVERSION_FIRST_UPGRADE_CTA]: "Upgrade Faster",
    [BASE_COPY_KEYS.PRO_CONVERSION_MAIN_TITLE]: "Become a Founding Sahib Pro Member. Play more battles, earn more coins, build faster, and join players worldwide in the skill-economy movement.",
    [BASE_COPY_KEYS.PRO_CONVERSION_MAIN_CTA]: "Start Sahib Pro",
    [BASE_COPY_KEYS.PRO_CONVERSION_LAUNCH_BADGE]: "Founding Member",
    [BASE_COPY_KEYS.PRO_BENEFIT_BATTLES_TITLE]: "Play more",
    [BASE_COPY_KEYS.PRO_BENEFIT_BATTLES_BODY]: "Unlimited quick battle access.",
    [BASE_COPY_KEYS.PRO_BENEFIT_COINS_TITLE]: "3x coins",
    [BASE_COPY_KEYS.PRO_BENEFIT_COINS_BODY]: "Win 300, draw 150, loss 75.",
    [BASE_COPY_KEYS.PRO_BENEFIT_TIMERS_TITLE]: "80% faster builds",
    [BASE_COPY_KEYS.PRO_BENEFIT_TIMERS_BODY]: "Future build timers use the Pro duration.",
    [BASE_COPY_KEYS.PRO_BENEFIT_SKILLS_TITLE]: "Skills still matter",
    [BASE_COPY_KEYS.PRO_BENEFIT_SKILLS_BODY]: "Skill challenges are still required.",
    [BASE_COPY_KEYS.PRO_COMPARISON_QUICK_BATTLES]: "Quick battles",
    [BASE_COPY_KEYS.PRO_COMPARISON_COINS]: "Coins",
    [BASE_COPY_KEYS.PRO_COMPARISON_TIMERS]: "Build timers",
    [BASE_COPY_KEYS.PRO_COMPARISON_SKILL_CHALLENGES]: "Skill challenges",
    [BASE_COPY_KEYS.PRO_COMPARISON_PAY_TO_WIN]: "Pay-to-win power",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_QUICK_BATTLES]: "4 full-reward hearts, then 30-min refill",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_COINS]: "Win 100 / Draw 50 / Loss 25",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_TIMERS]: "Normal",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_SKILL_CHALLENGES]: "Required",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_PAY_TO_WIN]: "No",
    [BASE_COPY_KEYS.PRO_COMPARISON_PRO_QUICK_BATTLES]: "Unlimited access",
    [BASE_COPY_KEYS.PRO_COMPARISON_PRO_COINS]: "Win 300 / Draw 150 / Loss 75",
    [BASE_COPY_KEYS.PRO_COMPARISON_PRO_TIMERS]: "80% faster",
  ...
  [BASE_LANGUAGES.AR]: Object.freeze({
    ...
    [BASE_COPY_KEYS.SKILL_FOUNDING_PRO_BADGE]: "مؤسس Pro",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_START_CTA]: "ابدأ تحدي المهارة",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_RETRY_CTA]: "أعد المحاولة",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_SCORE_LABEL]: "النتيجة",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_PASSED_LABEL]: "نجحت",
    [BASE_COPY_KEYS.SKILL_CHALLENGE_FAILED_LABEL]: "حاول مرة أخرى",
    ...
    [BASE_COPY_KEYS.PRO_CONVERSION_HEARTS_TITLE]: "عرض الإطلاق",
    [BASE_COPY_KEYS.PRO_CONVERSION_HEARTS_BODY]: "استخدمت كل معاركك المجانية بالمكافآت الكاملة. فعّل Pro لتكمل اللعب بدون انتظار ٣٠ دقيقة.",
    [BASE_COPY_KEYS.PRO_CONVERSION_HEARTS_CTA]: "العب بدون انتظار",
    [BASE_COPY_KEYS.PRO_CONVERSION_LOCKED_TITLE]: "افتح أسرع",
    [BASE_COPY_KEYS.PRO_CONVERSION_LOCKED_BODY]: "هذا المبنى مغلق. طوّر أسرع وافتح مملكتك المستقبلية مع Sahib Pro.",
    [BASE_COPY_KEYS.PRO_CONVERSION_LOCKED_CTA]: "افتح أسرع",
    [BASE_COPY_KEYS.PRO_CONVERSION_TIMER_STARTED_TITLE]: "مؤقتات مستقبلية",
    [BASE_COPY_KEYS.PRO_CONVERSION_TIMER_STARTED_BODY]: "بدأ التطوير. Sahib Pro يقلّل أوقات البناء القادمة بنسبة 80%.",
    [BASE_COPY_KEYS.PRO_CONVERSION_TIMER_STARTED_CTA]: "سرّع مع Pro",
    [BASE_COPY_KEYS.PRO_CONVERSION_FIRST_UPGRADE_TITLE]: "طوّر أسرع",
    [BASE_COPY_KEYS.PRO_CONVERSION_FIRST_UPGRADE_BODY]: "مملكتك تكبر. Sahib Pro يساعدك على التطوير بشكل أسرع.",
    [BASE_COPY_KEYS.PRO_CONVERSION_FIRST_UPGRADE_CTA]: "طوّر أسرع",
    [BASE_COPY_KEYS.PRO_CONVERSION_MAIN_TITLE]: "كن من أوائل أعضاء Sahib Pro. العب معارك أكثر، اجمع عملات أكثر، ابنِ أسرع، وانضم للاعبين حول العالم في حركة اقتصاد المهارة.",
    [BASE_COPY_KEYS.PRO_CONVERSION_MAIN_CTA]: "ابدأ Sahib Pro",
    [BASE_COPY_KEYS.PRO_CONVERSION_LAUNCH_BADGE]: "عضو مؤسس",
    [BASE_COPY_KEYS.PRO_BENEFIT_BATTLES_TITLE]: "العب أكثر",
    [BASE_COPY_KEYS.PRO_BENEFIT_BATTLES_BODY]: "وصول غير محدود للمعارك السريعة.",
    [BASE_COPY_KEYS.PRO_BENEFIT_COINS_TITLE]: "عملات 3x",
    [BASE_COPY_KEYS.PRO_BENEFIT_COINS_BODY]: "فوز 300، تعادل 150، خسارة 75.",
    [BASE_COPY_KEYS.PRO_BENEFIT_TIMERS_TITLE]: "بناء أسرع 80%",
    [BASE_COPY_KEYS.PRO_BENEFIT_TIMERS_BODY]: "المؤقتات المستقبلية تستخدم مدة Pro.",
    [BASE_COPY_KEYS.PRO_BENEFIT_SKILLS_TITLE]: "المهارات مهمة",
    [BASE_COPY_KEYS.PRO_BENEFIT_SKILLS_BODY]: "تحديات المهارة تبقى مطلوبة.",
    [BASE_COPY_KEYS.PRO_COMPARISON_QUICK_BATTLES]: "المعارك السريعة",
    [BASE_COPY_KEYS.PRO_COMPARISON_COINS]: "العملات",
    [BASE_COPY_KEYS.PRO_COMPARISON_TIMERS]: "مؤقتات البناء",
    [BASE_COPY_KEYS.PRO_COMPARISON_SKILL_CHALLENGES]: "تحديات المهارة",
    [BASE_COPY_KEYS.PRO_COMPARISON_PAY_TO_WIN]: "قوة مدفوعة",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_QUICK_BATTLES]: "4 قلوب بمكافآت كاملة ثم انتظار 30 دقيقة",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_COINS]: "فوز 100 / تعادل 50 / خسارة 25",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_TIMERS]: "عادي",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_SKILL_CHALLENGES]: "مطلوبة",
    [BASE_COPY_KEYS.PRO_COMPARISON_FREE_PAY_TO_WIN]: "لا",
    [BASE_COPY_KEYS.PRO_COMPARISON_PRO_QUICK_BATTLES]: "وصول غير محدود",
    [BASE_COPY_KEYS.PRO_COMPARISON_PRO_COINS]: "فوز 300 / تعادل 150 / خسارة 75",
    [BASE_COPY_KEYS.PRO_COMPARISON_PRO_TIMERS]: "أسرع 80%",
