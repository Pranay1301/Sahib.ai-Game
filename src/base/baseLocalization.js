...
const BASE_TRANSLATIONS = Object.freeze({
  [BASE_LANGUAGES.EN]: Object.freeze({
    ...
    [BASE_COPY_KEYS.UPGRADE_PRO_UPSELL_BODY]: "Sahib Pro uses {proTimer} instead of {freeTimer} for this upgrade.",
    [BASE_COPY_KEYS.UPGRADE_PRO_UPSELL_CTA]: "Unlock Sahib Pro",
  ...
  [BASE_LANGUAGES.AR]: Object.freeze({
    ...
    [BASE_COPY_KEYS.UPGRADE_PRO_UPSELL_BODY]: "Sahib Pro يستخدم {proTimer} بدلا من {freeTimer} لهذه الترقية.",
    [BASE_COPY_KEYS.UPGRADE_PRO_UPSELL_CTA]: "افتح Sahib Pro",
